...
restricts which other classes may directly extend it***. These are brand new to Java 17, so expect to see at least one question 
...
- **sealed:** Indicates that a class(normal an abstract) or interface may only be extended/implemented by named classes or interfaces.
...
```java
public class sealed Frog permits GlassForg {}       // DOES NOT COMPILE - WRONG ORDER
public final class GlassFrog extends Frog {}

public abstract sealed class Wolf permits Timer {}
public final class Timber extends Wolf {}
public final class MyWolf extends Wolf {}           // DOES NOT COMPILE - IT IS NOT LISTED IN THE DECLARATION WOLF
```
&emsp;&emsp;
...
Any time you see a sealed class on the exam, pay close attention to the subclasses declaration and modifiers.
**Sealed Class Rules**
