...
2. df
3. Which lambda can replace the method references in this code? 
```java
...
are telling the compilerto get you method of Function interface requires one argument and you have parameterized it to 
